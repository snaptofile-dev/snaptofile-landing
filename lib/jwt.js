 ...
 *     email:               buyer's email (optional — only included if provided),
 ...
 *
 * email is optional and additive (Chunk 6C, 2026-05-04). Old tokens issued
 * before this change continue to verify normally — the verifier in the Pro
 * HTML never required email to be present.
 */
export async function signLicenseToken({
  ...
  // email is intentionally optional — no validation. If present, it ships
  // in the payload; if not, the token is fully valid without it.
